...
%type <terminalParams> program functionset functionname function funcident ident declarationset 
...
functionname: //not sure if having a non-terminal named function and a terminal name FUNCTION causes an issue.
	FUNCTION funcident SEMICOLON { 
		cout << "functionname -> FUNCTION funcident SEMICOLON" << endl;
	};
...
funcident:
	IDENT {cout << "functident->IDENT" << endl;};
ident:
